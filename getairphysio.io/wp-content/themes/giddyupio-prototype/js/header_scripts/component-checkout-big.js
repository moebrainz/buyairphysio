!(function (e) {
  ...
  function t(e, r) {
    ...
    for (
      e.s = "-" == r.charAt(0) ? ((r = r.slice(1)), -1) : 1,
        ...
        (n = r.search(/e/i)) > 0
          ? (0 > t && (t = n), (t += +r.slice(n + 1)), (r = r.substring(0, n)))
          : 0 > t && (t = r.length),
        i = r.length,
        n = 0;
      i > n && "0" == r.charAt(n);
  ...
  function i(e, r, t, i) {
    ...
    if (t !== m) {
      if (t !== ~~t || (3 == r) > t || t > c)
        throw Error(3 == r ? g + "precision" : p);
      for (
        e = new f(e),
          t = i - e.e,
          e.c.length > ++i && n(e, t, f.RM),
          2 == r && (i = e.e + t + 1);
        e.c.length < i;
  ...
  (v.abs = function () {
    ...
    (v.pow = function (e) {
      ...
      for (i && (e = -e); 1 & e && (n = n.times(r)), (e >>= 1), e; )
        r = r.times(r);
      return i ? t.div(n) : n;
    }),
    ...
    (v.sqrt = function () {
      ...
      (s = Math.sqrt(i.toString())),
        0 === s || s === 1 / 0
          ? ((r = i.c.join("")),
            (r.length + f) & 1 || (r += "0"),
            (e = new o(Math.sqrt(r).toString())),
            (e.e = (((f + 1) / 2) | 0) - (0 > f || 1 & f)))
          : (e = new o(s.toString())),
        (f = e.e + (o.DP += 4));
      do (t = e), (e = c.times(t.plus(i.div(t))));
      while (t.c.slice(0, f).join("") !== e.c.slice(0, f).join(""));
